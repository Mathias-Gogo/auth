        ...
        <div className="container">
            <form action="" method="get">
                ...
                <div className="form-input">
                    <input id='name' type="name" placeholder="Name" autoComplete="Name" required />
